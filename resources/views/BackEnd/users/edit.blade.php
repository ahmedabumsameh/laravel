                  ...
                  <form action="{{ route('users.update', $row->id) }}" method="POST">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <label for="exampleInputtext1">@lang('site.name')</label>
                                <input type="text" class="form-control" value="{{ $row->name }}" name="name" placeholder="@lang('site.firstName')"  value="{{ old('firstName') }}">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputEmail1">@lang('site.email')</label>
                            <input type="email" class="form-control" name="email" value="{{ $row->email }}" placeholder="@lang('site.email')" value="{{ old('email') }}">
                        </div>
