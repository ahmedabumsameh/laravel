  ...
  <section class="content">
    ...
    <div class="col-xs-4">
            <div class="box box-primary">
              ...
              <!-- /.box-header -->
              <!-- form start -->
              <form action="{{ route($routName.'.replay',['id'=>$row->id]) }}" method="POST">
                    @include('BackEnd.'.$folderName.'.replay')
                <!-- /.box-body -->
                <div class="box-footer">
                  <button type="submit" class="btn btn-primary">ارسال الاميل</button>
                </div>
              </form>
            </div>
          </div>
